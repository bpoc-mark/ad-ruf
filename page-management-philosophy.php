...
<div class="page__content mp">
    ...
    <div class="mp__section_1">
        ...
        <div class="mp__section_1--main-content">
            <div class="l-wrap">
                <div class="row">
                    <div class="col">
                        <div class="col-left">
                            <p>
                                一人ひとりの大切なお客様のご期待に応え、結果を出し、そして選ばれ続ける。私たちはやみくもに新規開拓するのではなく、一人ひとりのお客様を大切にしております。一度お取引をさせていただいたお客様と生涯を通じて末長くお付き合いさせていただく、それこそが社員一人ひとりにとっての最大の喜びであり、誇りです。
                            </p>

                            <p class="u-pt-15">
                                取引先との関係も同じです。<br>
                                数ある仲介会社の中で、選ばれし仲介会社、数ある金融機関の中で、選ばれし金融機関、そんな特別な企業から選ばれ、そして選ばれ続ける存在でありたいと考えております。
                            </p>
                        </div>
                    </div>
            ...
            <div class="l-wrap">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="col-right">
                            <p>
                                10年後も、20年後も変わらず選ばれ続けるために大切にしていること、それは、人と人とのつながりです。インターネットが浸透した現代でも、物件を実際に見ずに契約する方はおりません。不動産との出会いは、必ず人と人との出会いから始まります。
                            </p>
