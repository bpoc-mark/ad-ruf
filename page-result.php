    ...
    <div class="section_1">
        ...
        <div class="clip-path">
            <div class="l-wrap">
                ...
                <h1 class="c-case01__title result_ttl">丸の内ルーフはさらなる長期的発展を目指して参ります。</h1>
                <p class="c-case01__sub">私たち丸の内ルーフは創業以来、赤字を出すことなく、<br>利益水準を持続的に成長させてきました。</p>
                ...
                <p class="section_1__chart-ins">カーソルを合わせると各年度の<br class="br-sp">詳細な業績が見られます。<br>
                    スマホ、タブレットの場合、グラフを拡大してタップしていただくと数値がご覧いただけます。<br class="br-sp">※グループ会社の売上含まず</p>
                <div class="section_1__result_btns">
                    ...
                    <div class="c-buttonCase button-2">
