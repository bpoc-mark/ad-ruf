...
<div class="page__content interview">
    <div class="c-banner">
        ...
        <div class="c-inner">
            ...
            <div class="c-banner--ttl">
                <!-- <p>CEO of RUF</p> -->
                <!-- <img src="<?php echo $imagedir ?>/release/image/page/interview/txt_bnr.png" alt=""> -->
                <!-- <p>Interview</p> -->
            </div>
        </div>
    ...
    <div class="section_1">
        ...
        <div class="clipPath">
            <div class="l-wrap">
                <img class="bg_1" src="<?php echo get_template_directory_uri(); ?>/release/image/page/interview/bg_1.png" alt="">
                <img class="bg_2" src="<?php echo get_template_directory_uri(); ?>/release/image/page/interview/bg_2.png" alt="">
                ...
                <div class="section_1-cntnt">
                    <div class="u-d-f cntnt-wrppr">
                        <div class="section_1-cntnt-1">
                            <p class="section_1-cntnt-1-hdr">父の言葉を信じて<br>不動産の道へ。</p>
                            <p class="section_1-cntnt-1-txt1">不動産業界を志したきっかけ、<br>そしてルーフ設立に至った経緯は？</p>
                            <p class="section_1-cntnt-1-txt2">
                                私の母は看護師、そして父は公務員でした。父は転勤が多かったため、その後民間のリゾート開発会社に転職をしました。一時は栄華を誇ったのですが、会員権ビジネスが停滞して倒産してしまったんです。それからは小さな家に引っ越しをして、父と母の頑張りを見てきたわけですが、その時感じたのは「いくら頑張っても会社の根底が揺らいでしまうと会社員というのは悲哀を味わうのだな」ということでした。私は物心つく頃から、訪問販売の営業をしていた父の後ろについて、一件一件一緒に回っていたんです。そういった父の姿を間近で見て、いつか自分も独立してビジネスをやりたいと思ったのが、小さい頃に根付いた「起業のきっかけ」でした。<br><br>
                                大学に入ってからもその気持ちが絶えることもなく、卒業の頃父に「どんな仕事がいいのか」と相談をしたところ、不動産がいいと勧められたんです。なぜ不動産がいいのかを尋ねると、「不動産は輸出も輸入も産業革命もないからだ」と。私は当時ポケベルを持っていたんですが、「武史、これからはポケベルなんてなくなるぞ。いずれタケコプターで物を運ぶ時代が来る。携帯電話は時計の中に入っていて画像が映る時代が来る。全ての物が変わる時代が来る。でも不動産だけは輸出も輸入も産業革命もないから、早い段階からきちんと仕事をしておけば一生食っていけるぞ」という話がありました。
                            </p>
                            <!-- <div class="section_1-cntnt-1-biography">
                                <p class="section_1-cntnt-1-biography-hdr">代表取締役 木村武史の略歴</p>
                                <div class="section_1-cntnt-1-biography-cntnt u-d-f">
                                    <p class="section_1-cntnt-1-biography-cntnt-yr">0000年</p>
                                    <p class="section_1-cntnt-1-biography-cntnt-txt">この文章はダミーです</p>
                                </div>
                                <div class="section_1-cntnt-1-biography-cntnt u-d-f">
                                    <p class="section_1-cntnt-1-biography-cntnt-yr">0000年</p>
                                    <p class="section_1-cntnt-1-biography-cntnt-txt">この文章はダミーです</p>
                    ...
                    <div class="u-d-f cntnt-wrppr cntnt-wrppr-reverse">
                        ...
                        <div class="section_1-cntnt-2">
                            <img class="sec1img" src="<?php echo get_template_directory_uri(); ?>/release/image/page/interview/sec1_img2.png" alt="">
                        </div>
                    </div>

                    <div class="u-d-f cntnt-wrppr cntnt-wrppr--last">
                        <div class="section_1-cntnt-1">
                            <p class="section_1-cntnt-1-txt1">RUFという社名の由来は？</p>
                            <p class="section_1-cntnt-1-txt2">
                                それはすごく単純で、実はRUFというスーパーカーがあるんです。ポルシェの中古車をカスタマイズして本家よりも高性能の車を作り上げるメーカーなんです。それが「中古物件をカスタマイズして新築物件に負けないような価値を作る」という弊社の理念と非常に似ていたんです。そういったリンクする点からRUFという社名にしました。
                            </p>
                        </div>

                        <div class="section_1-cntnt-2">
                            <img class="sec1img" src="<?php echo get_template_directory_uri(); ?>/release/image/page/interview/sec1_img3.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="l-wrap">
            <div class="section_2-cntnt">
                ...
                <!-- <div class="u-d-f section_2-cntnt-btns">
                    ...
                    <a class="c-buttonCase" href="<?php echo get_permalink(get_page_by_path('interview')) ?>">
            ...
            <div class="l-wrap">
                <div class="section_3-cntnt">
                    ...
                    <div class="section_3-cntnt-rows u-d-f u-jc-sb">
                        <div class="section_3-cntnt-rows-1">
                            <p class="section_3-cntnt-rows-1-txt1 npt">会社経営とレーサーを両立させる<br>
                                バイタリティの源は？</p>

                            <p class="section_3-cntnt-rows-1-txt2">家族を養うとか、お客様にきちんとした仕事を提供するとか、社員に給与を支払うとか、そういうことは当たり前だと思っています。私はプロの経営者なので。ただ、当たり前のことを当たり前にやっているだけだと、あまり自分の中でモチベーションが出ないんです。ところがレーサーをやりながらそれをやるというのは、結構敷居が高くなるんです。私はレースで結果を出しながら、当たり前に会社を経営したい。会社が厳しくなったらレースは辞めます。ところがレースを続けられるということは、圧倒的な財務基盤を保ってないとさすがにレースはできないです。そういった意味では、自分の大きなモチベーションのためにレースがあるのだと思います。</p>
                        </div>
                        <div class="section_3-cntnt-rows-2">
                            <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/interview/sec3-img2.png" alt="">
                        </div>
                    </div>

                    <div class="section_3-cntnt-rows section_3-cntnt-rows--reverse u-d-f u-jc-sb">
                        <div class="section_3-cntnt-rows-1">
                            <p class="section_3-cntnt-rows-1-txt1 npt">レーサーとしてのこれまでの道のりは？</p>

                            <p class="section_3-cntnt-rows-1-txt2">45歳までは全く未経験でした。45歳で国内B級、A級ライセンスを取って、ランボルギーニのワンメイクレースに出場しました。そこでいきなり速く走れました。その結果年間シリーズで2位を獲得出来ました。そこからスーパーGT、スーパー耐久、そしてアジアンル・マンという国際カテゴリにだんだん入ってきました。ライセンスも国際ライセンスC、国際ライセンスBとステップアップして。もはやその上はA級ライセンスとスーパーライセンスしかないんですけど、年間のお金がかかるので取ってない、というのが今の状況です。 国際ライセンスを受けてからも結構勝ち出したんです。勝ち出すとスポンサーもどんどん付いてきて、今では年間3~4億円くらいスポンサーが付いています。フェラーリで乗らないか、というオファーも来て。趣味で始めたものに結果が伴ってきたので結果としてプロ化していったというところなんですね。その後世界最高峰のF1と並ぶル・マン24Hにも出られて、初年度が総合クラスで5位という成績を得ることができました。それ以降の2戦は海外名門チームからオファーをいただいたので、プロとして参戦しました。</p>
                        </div>
                        <div class="section_3-cntnt-rows-2">
                            <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/interview/sec3-img3.png" alt="">
                        </div>
                    </div>
                    ...
                    <div class="section_3-cntnt-rows section_3-cntnt-rows--last u-d-f u-jc-sb">
                        <div class="section_3-cntnt-rows-1">
                            ...
                            <p class="section_3-cntnt-rows-1-txt2">説明するのが難しいのですが、車を運転していて「タイヤがどのように路面と接しているか」が私にはわかるんです。タイヤと路面がくっついていれば、どんな速度でも曲がれるし止まれるんです。曲がれない、止まれないというのは、グリップが限界に到達して破綻してしまうわけなんです。ということは限界に到達するギリギリのところで走るのが一番速い、ということになりますよね。その限界がわかるかわからないかがレーサーの資質なんです。大事なのはタイヤから足回り、シャーシを通して座席に伝わるセンサーなんです。私はタイヤがアスファルトにめり込む感じがわかるんです。</p>
                        </div>
                        <div class="section_3-cntnt-rows-2">
                            <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/interview/sec3-img4.png" alt="">
                        </div>
                    </div>
    ...
    <div class="section_2 section_2--2">
