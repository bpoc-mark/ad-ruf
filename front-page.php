                        ...
                        <div class="sect_3-cntnt-row-02">
                            ...
                            <div class="sect_3-cntnt-row-02-txt">
                                <p class="sect_3-cntnt-row-02-txt-03">
                                    丸の内ルーフは単なる仲介業者ではありません。自社で収益不動産を保有する「プロのオーナー」として、首都圏を中心に多数の物件を運用しています。市況に応じたポートフォリオを構築することで、収益率の高い運営を実現します。
                                </p>
                            </div>
                        ...
                        <div class="sect_4-cntnt-row-01">
                            ...
                            <div class="sect_4-cntnt-row-01-txt">
                                <p class="sect_4-cntnt-row-01-txt-03">
                                    丸の内リーフでは、これまで培った収益不動産に関する豊富なノウハウを活かし、お客様の目的に沿ってリスクとリターンをコントロール。オーナー様の不動産投資戦略の最適化を叶えるとともに、資産価値の最大化を目指します。
                                </p>
                            </div>
