                ...
                <div class="sect_1-cntnt">
                    <div class="sect_1-cntnt-row">
                        ...
                        <div class="sect_1-cntnt-row-02">
                            ...
                            <a href="<?php echo get_permalink(get_page_by_path('realestatepurchase')) ?>" class="c-buttonCase u-l-algn">
                ...
                <div class="sect_7-cntnt">
                    <div class="sect_7-cntnt-rows u-d-f u-jc-sb">
                        ...
                        <div class="sect_7-cntnt-rows-02">
                            ...
                            <div class="sect_7-cntnt-rows-02-txt">
                                <p class="sect_7-cntnt-rows-02-txt-03">不動産投資におきまして、<br class="u-d-n-sp">最も大切なことは<br class="u-d-n-pc">所有されている収益不動産の価値を保ちながら <br>売却時期を逃さない事。
                                    <br>その為、当社のスタッフは専門知識は勿論、<br class="u-d-n-pc">目利きの確かさ、<br class="u-d-n-sp">きめ細かいサービス、先任責任主義、迅速な行動、発想の展開性など <br>
                                    的確に業務を遂行するノウハウが一人残らず<br class="u-d-n-pc">浸透しております。<br>収益不動産のエキスパートとして、<br class="u-d-n-pc">お客様に満足して頂く為に、<br>スタッフ一同磐石の体制でお客様のニーズを<br class="u-d-n-pc">現実化していきます。<br>今後とも宜しくお願い申し上げます。
                                </p>
                            </div>
