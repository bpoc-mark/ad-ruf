...
<div class="page__content top">
    <section class="sect_1">
        ...
        <div class="clipPath">
            ...
            <div class="l-wrap">
                <img class="bg_1" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_1.png"
                    alt="">
                <img class="bg_2" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_2.png"
                    alt="">
                <img class="bg_3" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_3.png"
                    alt="">
                <img class="bg_sec1_sp u-d-n-pc"
                    src="<?php echo get_template_directory_uri(); ?>/release/image/background/sec1_sp.png" alt="">
                ...
                <div class="sect_1-hdr">
                    ...
                    <div class="sect_1-hdr-sub">
                        <p class="sect_1-hdr-sub-txt">【丸の内】ルーフの<br>4つの事業を<br class="u-d-n-pc">ご紹介いたします。
                        </p>
                    </div>
                ...
                <div class="sect_1-cntnt">
                    <div class="sect_1-cntnt-row">
                        <div class="sect_1-cntnt-row-01">
                            ...
                            <div class="col--box">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/top-page/sect1_bimg01.png"
                                    alt="Real Estate Purchase">
                        ...
                        <div class="sect_1-cntnt-row-02">
                            ...
                            <div class="sect_1-cntnt-row-02-txt">
                                <p class="sect_1-cntnt-row-02-txt-03">
                                    丸の内ルーフは、首都圏エリアの不動産価値の動向を見極め、あなたの大切な一棟マンションやアパートなどの収益不動産を最大限に評価。収益不動産のプロによる確かな目と圧倒的なスピードによって、最適価格での売買を実現します。
                                </p>
                            </div>
    ...
    <section class="sect_2">
        ...
        <div class="clipPath">
            <div class="l-wrap">
                <img class="bg_4" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_4.png"
                    alt="">
                <img class="bg_5" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_5.png"
                    alt="">
                <img class="bg_sp u-d-n-pc"
                    src="<?php echo get_template_directory_uri(); ?>/release/image/background/sec2bg_sp.png" alt="">
                <img class="bg_6" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_6.png"
                    alt="">
                <div class="sect_2-cntnt">
                    <div class="sect_2-cntnt-row">
                        <div class="sect_2-cntnt-row-01">
                            ...
                            <div class="sect_2-cntnt-row-01-txt">
                                <p class="sect_2-cntnt-row-01-txt-02">Real Estate Management</p>
                            </div>
                            <div class="sect_2-cntnt-row-01-txt">
                                <p class="sect_2-cntnt-row-01-txt-03">
                                    丸の内リーフは、豊富なバリューアップの経験を武器に最適な不動産管理を行います。幅広いネットワークによる入居者募集、人気物件へと生まれ変わらせるリノベーション、入居者様に安心して長期契約いただけるサポートまで、お預かりした大切な収益不動産の価値を守り、高めます。
                                </p>
                            </div>

                            <a href="<?php echo get_permalink(get_page_by_path('realestatemanagement')) ?>"
                        ...
                        <div class="sect_2-cntnt-row-02">
                            ...
                            <div class="col--box">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/top-page/sect2_bimg01.png"
                ...
                <div class="sect_3-cntnt">
                    <div class="sect_3-cntnt-row">
                        <div class="sect_3-cntnt-row-01">
                            ...
                            <div class="col--box">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/top-page/sect3_bimg01.png"
                        ...
                        <div class="sect_3-cntnt-row-02">
                            <div class="sect_3-cntnt-row-02-txt">
                                <p class="sect_3-cntnt-row-02-txt-01">収益不動産の運用</p>
                            </div>
                            <div class="sect_3-cntnt-row-02-txt">
                                <p class="sect_3-cntnt-row-02-txt-02">Real Estate Operation</p>
                            </div>
                            <div class="sect_3-cntnt-row-02-txt">
                                <p class="sect_3-cntnt-row-02-txt-03">
                                    ルーフは単なる仲介業者ではありません。自社で収益不動産を保有する「プロのオーナー」として、首都圏を中心に多数の物件を運用しています。市況に応じたポートフォリオを構築することで、収益率の高い運営を実現します。
                                </p>
                            </div>

                            <a href="https://www.ruf.jp/business/operation.html" target="_blank"
                                class="c-buttonCase u-l-algn wh">
    ...
    <section class="sect_4">
        <div class="clipPath">
            <div class="l-wrap">
                <img class="bg_1_rd"
                    src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_1_rd.png" alt="">
                <img class="bg_2_rd"
                    src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_2_rd.png" alt="">
                <img class="bg_3_rd"
                    src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_3_rd.png" alt="">
                <img class="bg_2_rd_sp"
                    src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_2_rd_sp.png" alt="">
                <div class="sect_4-cntnt">
                    <div class="sect_4-cntnt-row">
                        <div class="sect_4-cntnt-row-01">
                            <div class="sect_4-cntnt-row-01-txt">
                                <p class="sect_4-cntnt-row-01-txt-01">アセットマネジメント</p>
                            </div>
                            <div class="sect_4-cntnt-row-01-txt">
                                <p class="sect_4-cntnt-row-01-txt-02">Asset Management</p>
                            </div>
                            <div class="sect_4-cntnt-row-01-txt">
                                <p class="sect_4-cntnt-row-01-txt-03">
                                    ルーフでは、これまで培った収益不動産に関する豊富なノウハウを活かし、お客様の目的に沿ってリスクとリターンをコントロール。オーナー様の不動産投資戦略の最適化を叶えるとともに、資産価値の最大化を目指します。
                                </p>
                            </div>

                            <a href="<?php echo get_permalink(get_page_by_path('assetmanagement')) ?>"
                                class="c-buttonCase u-l-algn rd">
                        ...
                        <div class="sect_4-cntnt-row-02">
                            ...
                            <div class="col--box">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/top-page/sect4_bimg01.png"
    ...
    <section class="sect_5">
        <div class="clipPath">
            <div class="l-wrap">
                <img class="bg_7" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_7.png"
                    alt="">
                <img class="bg_8" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_8.png"
                    alt="">
                <div class="sect_5-cntnt">
                    <div class="sect_5-cntnt-txt">
                        ...
                        <p class="sect_5-cntnt-txt-desc">
                            20年で500棟の売買、2000戸、100テナントの管理・運用を行なってきた丸の内ルーフ。ここではその事例の一部をご紹介します。
    ...
    <section class="sect_6">
        <div class="clipPath">
            <div class="c-case--items fp">
                <div class="l-wrap">
                    <img class="bg_1"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/page/top-page/bg_1.png" alt="">
                    <img class="bg_6_sp"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/background/sec6_bg_sp.png"
                        alt="">
                ...
                <div class="l-wrap sp_p0">
                    <img class="bg_2"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/page/top-page/bg_2.png" alt="">
                    <img class="bg_3"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/page/top-page/bg_3.png" alt="">
                    <div class="c-slider slider">
                        <div class="c-slider__item">
                            <div class="bg_img">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/case/csm-case09.png"
                                    alt="">
                        ...
                        <div class="c-slider__item">
                            <div class="bg_img">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/case/csm-case10.png"
                                    alt="">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/logo.svg" alt="">
                        ...
                        <div class="c-slider__item">
                            <div class="bg_img">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/page/case/sect_3_img.png"
                                    alt="">
                                <img src="<?php echo get_template_directory_uri(); ?>/release/image/logo.svg" alt="">
    ...
    <section class="sect_7">
        <div class="clipPath">
            <div class="l-wrap">
                <img class="bg_11" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_11.png"
                    alt="">
                <img class="bg_10" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_10.png"
                    alt="">
                            ...
                            <div class="sect_7-cntnt-rows-02-txt">
                                <p class="sect_7-cntnt-rows-02-txt-03">不動産投資におきまして、<br class="u-d-n-sp">最も大切なことは<br
                                    ...
                                    的確に業務を遂行するノウハウが一人残らず<br class="u-d-n-pc">浸透しております。<br>収益不動産のエキスパートとして、<br
                                        ...
                                        class="u-d-n-pc">現実化していきます。<br>今後とも宜しくお願い申し上げます。
                                </p>
                            </div>
    ...
    <section class="sect_8">
        <div class="l-wrap">
            <img class="bg_12" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_12.png"
                alt="">
            <img class="bg_13" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_13.png"
                alt="">
            <img class="bg_14" src="<?php echo get_template_directory_uri(); ?>/release/image/background/bg_14.png"
                alt="">
