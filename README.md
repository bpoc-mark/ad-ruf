...
-   [:rocket: Installing RUF](#Installing)
-   [:computer: Usage of RUF](#Usage)
...
## <a name='Installing'></a> :rocket: Installing RUF

To install RUF in your local machine, follow this instructions
...
```sh
git clone -b <your_branch> https://github.com/bpoc-mark/ad-ruf.git
```

After cloning, open your wordpress dashboard and activate the theme.

## <a name='Usage'></a>:computer: Usage of RUF
