...
<div class="page__content case case07">
    ...
    <div class="section_1 case07--s1">
        ...
        <div class="c-case--items">
            ...
            <div class="l-wrap">
                <img class="bg_2 case07--s1_hide" src="<?php echo $imagedir ?>/release/image/page/case/bg_2.png" alt="">
                <div class="c-case--items__contents">
        ...
        <!-- //CONTENT 4 -->
        <div class="c-case--items case07--s1_c4">
            <!-- <div class="c-clipbg__CS2"></div> -->
            <div class="l-wrap">
                <img class="case07--bg-01" src="<?php echo $imagedir ?>/release/image/page/case07/c8-s2-bg_1.png" alt="">
                <div class="c-case--items__contents">
                    <img class="bg_3" src="<?php echo $imagedir ?>/release/image/page/case/bg_3.png" alt="">
                    <div class="c-case--items__contents--row_1">
                        <div class="img-1">
