...
?>
<div class="page__content assetmanagement">
    <div class="c-banner">
        ...
        <div class="c-inner">
            <img class="bnr_pc" src="<?php echo $imagedir ?>/release/image/realestate/am_banner.png" alt="">
            <img class="bnr_sp" src="<?php echo $imagedir ?>/release/image/realestate/am_banner_sp.png" alt="">
            <div class="c-banner--ttl">
                <p>アセット<br class="u-d-n-pc">マネジメント</p>
        ...
        <div class="sect_1__center">
            <div class="l-wrap">
                ...
                <p class="sect_1__headers">
                    <span class="ttl_small">収益不動産に関する豊富なノウハウを活かし、</span> <br>
                    不動産投資戦略の最適化と<br class="u-d-n-pc">資産価値の<br class="u-d-n-pc">最大化を目指します。
                </p>
        ...
        <div class="l-wrap">
            <div class="sect_2__inner-realestate">
                ...
                <div class="sect_2__inner-realestate--left">
                    ...
                    <p class="text">
                        不動産投資の基本は、最適な時期に物件を購入し、資産価値を最大限高め、最適な時期に売却することです。ルーフの強みは、自社で収益不動産を保有する「プロフェッショナル」としての豊富な経験。この経験があるからこそ、「オーナー様目線」でアセットマネジメントを行うことができるのです。市場の最先端で培われた経験から導かれた戦略を駆使して、オーナー様の資産形成を力強く支えます。
                    </p>
                    <div class="point">
                ...
                <div class="sect_2__inner-realestate--right">
                    <img class="pic"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/realestate/am_img3.png" alt="">
        ...
        <div class="l-wrap">
            ...
            <div class="sect_4--top-realestate">
                ...
                <div class="sect_4__header">
                    ルーフのアセット<br class="u-d-n-pc">マネジメント 3つの特徴
                </div>
            ...
            <div class="sect_4__inner-realestate">
                <div class="sect_4__inner-realestate--left">
                    ...
                    <p class="text">
                        不動産投資の基本は、最適な時期に物件を購入し、資産価値を最大限高め、最適な時期に売却することです。ルーフの強みは、自社で収益不動産を保有する「プロフェッショナル」としての豊富な経験です。この経験があるからこそ、「オーナー様目線」でアセットマネジメントを行うことができるのです。市場の最先端で培われた経験から導かれた戦略を駆使して、オーナー様の資産形成を力強く支えます。
                    </p>
                    <div class="point">
                        <p class="point_ttl">
                            Point
                ...
                <div class="sect_4__inner-realestate--right">
                    <img class="pic"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/realestate/am_img1.png" alt="">
        ...
        <div class="l-wrap">
            ...
            <div class="sect_5__inner-realestate">
                ...
                <div class="sect_5__inner-realestate--right">
                    <img class="pic"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/realestate/am_img4.png" alt="">
                    <div class="c-img_box03">
                        <div class="c-img_box03__txt">
                            <p class="c-img_box03__ttl">Point</p>
        ...
        <div class="l-wrap">
            ...
            <div class="sect_6__inner-realestate">
                ...
                <div class="sect_6__inner-realestate--right">
                    <img class="pic"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/realestate/am_img2.png" alt="">
                    <div class="c-img_box03">
                        <div class="c-img_box03__txt">
                            <p class="c-img_box03__ttl">Point</p>
    ...
    <section class="sect_7">
        <div class="l-wrap">
            ...
            <div class="sect_7--top-casestudy">
                ...
                <div class="sect_7__header--sub">20年で500棟の売買、2000戸、100テナントの管理・運用を行なってきたルーフ。ここではその事例の一部をご紹介します。<br
    ...
    <section class="sect_8">
        <div class="l-wrap">
            <div class="sect_8__box-big-new">
                <img src="<?php echo get_template_directory_uri(); ?>/release/image/realestate/sect_8_box-1.png.png"
                    alt="">
            </div>
