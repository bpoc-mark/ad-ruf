        ...
        <div class="l-wrap">
            ...
            <div class="sect_4__inner-realestate">
                ...
                <div class="sect_4__inner-realestate--right">
                    <img class="pic pc" src="<?php echo get_template_directory_uri(); ?>/release/image/realestate/am_img1.png" alt="">
                    <img class="pic sp" src="<?php echo get_template_directory_uri(); ?>/release/image/realestate/am_img1-sp.png" alt="">
    ...
    <section class="sect_7">
        <div class="l-wrap">
            ...
            <div class="sect_7--top-casestudy">
                ...
                <div class="sect_7__header--sub">20年で500棟の売買、2000戸、100テナントの管理・運用を行なってきたルーフ。ここではその事例の一部をご紹介します。<br class="u-d-n-sp">お客様の物件の稼働率および資産価値の向上のため、きめ細やかなアプローチを行なっています。
                </div>
            </div>
